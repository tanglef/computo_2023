...
Given the sample of the audio of a species (the letter), users were presented with a new audio sample (the candidate).
...
We then can run our aggregation strategies.
...
{{< video ./datasets/birds_audio/bird_sound_training_data/audio_files/HLO04_20180511_034424_15.mp3 width="50%" >}}
...
print("Worse workers using GLAD", worse_glad)
print("Worse workers using DS trace", worse_ds)
print("Worse workers using Spam Score", worse_spam)
```
