...
Crowdsourced datasets come in various
...
Classical datasets in crowdsourcing such as CIFAR-10H and LabelMe can be installed directly using `peerannot` (an example is provided in @sec-real-datasets)
