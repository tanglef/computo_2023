...
#| code-fold: true
#| label: fig-cifarh
#| fig-cap: Example of images from CIFAR-10H. We display images rowise according to the label given in the test set of CIFAR10.
...
#| code-fold: true
#| label: fig-labelme
#| fig-cap: Example of images from LabelMe. We display images rowise according to the label given in the train set of LabelMe.
